#This file is part of the Project Applied ML Cooking repository. It was run in Colab.
# -*- coding: utf-8 -*-

"""RecipeQA_NaiveBayes.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1URrfJ5uHOkhI0Yp3jJHcfH1ZPHe3E7vh
"""
...
num_choices = 4
max_features = 10000
model_path = "/content/drive/MyDrive/Project_Applied_ML_Cooking/naive_bayes_model"
...
def show_predictions(model, X_texts, y_true, dataset, dataset_name="Dataset", group_size=num_choices, num_examples=5):
    ...
    for i in range(0, len(probs), group_size):
        ...
        print(f"\nQuestion {count + 1}: {example['question_text']}")
